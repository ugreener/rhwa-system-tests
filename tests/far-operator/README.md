...
Tests validating integration between Node Healthcheck (NHC) and Fence Agents Remediation (FAR) through FenceAgentsRemediationTemplate (FARTemplate).

### 22. Verify NHC-Triggered FAR Remediation via FARTemplate ([OCP-61309](https://polarion.engineering.redhat.com/polarion/#/project/OSE/workitem?id=OCP-61309))

Triggers FAR remediation through an NHC resource and FARTemplate after stopping kubelet on a worker node.

### 23. Verify NHC+FAR Default Reboot When FARTemplate Omits Action ([OCP-66204](https://polarion.engineering.redhat.com/polarion/#/project/OSE/workitem?id=OCP-66204))

Validates that FAR defaults to reboot when the FARTemplate omits the action parameter.
